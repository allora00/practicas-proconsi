...
fun diferencia(fechaFormat1: LocalDate, fechaFormat2: LocalDate) {
    val diferenca = ChronoUnit.DAYS.between(fechaFormat1, fechaFormat2).absoluteValue
    println("\n--- DIFERENCIA ---\nHay una diferencia de $diferenca dias\n")
}
...
fun dias(fechaFormat1: LocalDate, fechaFormat2: LocalDate) {
    ...
    println("--- DIAS HASTA FIN DE AÑO ---\nDias 1º fecha: $dias1  Dias 2º fecha: $dias2\n")
}
...
fun semanas(fechaFormat1: LocalDate, fechaFormat2: LocalDate) {
    ...
    println("---SEMANAS HATA FIN DE AÑO ---\nSemanas 1º fecha: $dias1  Semanas 2º fecha: $dias2\n")
}